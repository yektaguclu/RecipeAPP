...
<?php
    ...
    //SQL query string
    $sql = "INSERT INTO recipes (name, skillLevel, prepTime, cookTime, servingQuantity, ingredients, instructions)
    VALUES ('" . $_POST["recipeName"] . "', '" . $_POST["skill"] . "', '" . $_POST["prep"] . "', '" . $_POST["cookTime"] . "', '" . $_POST["servingSize"] . "','" . $_POST["ingredients"] . "','" . $_POST["instructions"] . "');";
...
<div class="container">
    <button class="btn btn-primary" onclick="window.location.href='../findARecipe.php';" style="text-align:center;position: absolute;left: 50%;-ms-transform: translate(-50%, -50%);transform: translate(-50%, -50%);">Find your Recipe!</button>
</div>
