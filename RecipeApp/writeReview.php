...
<h2 class="display-4 fst-italic text-black" style="text-align: center;padding-top:1%;">
...
<div class="container">
        <form method="post" action=<?php echo '"'. "./phpFunctions/updateReviewTable.php?id=" . $_GET["id"] . '"';?>>
        ...
        <div class="form-group">
            ...
            <textarea type="text" class="form-control" id="content" placeholder="Tell everyone what you feel" rows="10" name="content"></textarea>
        </div>
